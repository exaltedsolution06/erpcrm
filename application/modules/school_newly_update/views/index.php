		...
		<div class="page-header">
			<div class="row align-items-center">
				...
				<div class="col-auto float-end ms-auto">
					<a href="<?= base_url('school_newly_update/create') ?>" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Add</a>
				</div>
			</div>
		</div>
		<!-- /Page Header -->
								...
								<td class="text-end">
									<div class="dropdown dropdown-action">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="<?= base_url('school_newly_update/edit/'.$row->id) ?>"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
